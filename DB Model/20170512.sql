...
CREATE TABLE `ExpenseReport` (
  ...
  `CurrencyValueId` int(11) NOT NULL,
  ...
  KEY `fk_CurrencyValueId` (`CurrencyValueId`),
  CONSTRAINT `CurrencyValueId_fk` FOREIGN KEY (`CurrencyValueId`) REFERENCES `CurrencyValue` (`idCurrencyValue`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `User` VALUES (7,14,'teerer','lalalala','',2),(8,1000,'xxx','xxx','',1),(9,3,'Nancy','nanaromo@gmail.com','',2),(10,319,'bernal','sdfsdf','',2),(11,318,'Bernal Araya','bernala@gmail.com','',2);
...
-- Dump completed on 2017-05-12 20:11:11
